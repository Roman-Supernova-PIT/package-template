...
* Make yourself a branch of your repo in which you will do the package template adaption, and check out that branch.
...
* Run any tests you need to run to convince yourself you haven't changed the functionality of your package.

* Submit a PR with the changes you've made to adapt to the package template.

**NOTE** : the PR you make that adapts your package to the package template will fail the "prevent manually editing changelot" test.  This is OK.  Subsequent PRs should not fail this test if you do things right.
